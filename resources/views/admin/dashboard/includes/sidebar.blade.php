<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('dashboard') }}">
        ...
        <div class="sidebar-brand-text mx-3">News Daily</div>
    </a>
    ...
    <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Website Users:</h6>
    ...
    <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
            ...
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="">Writing</a>
                <a class="collapse-item" href="">Reading</a>
                <a class="collapse-item" href="">Permalink</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseNews" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Website News:</h6>
                <a class="collapse-item" href="{{ route('news.add-news') }}">Add New News</a>
                <a class="collapse-item" href="{{ route('news.manage-news') }}">Manage All News</a>
                <a class="collapse-item" href="{{ route('news.all-news') }}">All News</a>
            </div>
        </div>
    </li>
    <li class="nav-item">
